...
#define INFO_WINDOW_LEFT_MARGIN (INFO_WINDOW_FRAME_LEFT_MARGIN + 6)
#define INFO_WINDOW_WIDTH 192
#define INFO_WINDOW_ROW_SPACING 6
...
#define RESTART_CHAR_TOP_MARGIN (RESTART_BUTTON_TOP_MARGIN + 6)
#define RESTART_CHAR_LEFT_MARGIN (RESTART_BUTTON_LEFT_MARGIN + (RESTART_BUTTON_WIDTH - RESTART_CHAR_WIDTH) / 2 + 2)
...
#define EXIT_CHAR_LEFT_MARGIN (EXIT_BUTTON_LEFT_MARGIN + (EXIT_BUTTON_WIDTH - EXIT_CHAR_WIDTH) / 2 + 2)
